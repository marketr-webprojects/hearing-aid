...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Every service you need under one roof, from licensed clinicians.",
  },
};
      ...
      <section className="bg-background py-16 md:py-24">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Reveal delay={80}><ServiceCard icon={<Headphones className="size-6" />} title="Hearing Aid Fitting & Customization" desc="Matched to your lifestyle, hearing loss and budget." to="/services/hearing-aid-fittings" /></Reveal>
            <Reveal delay={160}><ServiceCard icon={<Wrench className="size-6" />} title="Hearing Aid Repair & Maintenance" desc="Fast, reliable service for various brands." to="/services/hearing-aid-repairs" /></Reveal>
