...
export const metadata: Metadata = {
  ...
  description:
    "Accurate adult and pediatric hearing tests in Tanay, Cebu, Dasmariñas and La Union — pure tone & speech audiometry, tympanometry, newborn hearing screening, play audiometry, ABR/BAER and ASSR, plus occupational, seafarer and pilot hearing screening.",
  keywords: [
...
export default function Page() {
  return (
    <SubPage
      ...
      subtitle="Accurate hearing assessments for adults and children, using the latest audiometric tools to measure hearing capacity precisely."
    >
      <p>
        A proper diagnosis is the foundation of good hearing care. Whether you&rsquo;re an adult noticing changes in
        your hearing or a parent concerned about your child, our licensed audiologists choose the right combination of
      ...
      <p>
        ...
        available across all four Linaw Dinig branches in Tanay (Rizal), Cebu, Dasmariñas (Cavite) and La Union.
      </p>

      <h2 className="text-2xl md:text-3xl">Adult Hearing Tests</h2>
      <div className="grid gap-5 md:grid-cols-3">
        <ImageCard title="Pure Tone Audiometry" img="/assets/pure-tone-audiometry.webp" alt="Patient wearing audiometric headphones in a sound-treated booth during a pure tone hearing test">
          Measures the softest sounds you can hear across a range of pitches to map the type and degree of your hearing loss.
        </ImageCard>
        <ImageCard title="Tympanometry" img="/assets/tympanometry.webp" alt="Audiologist performing a tympanometry middle-ear test on a patient">
          Checks how well your eardrum and middle ear move, helping detect fluid, blockage or pressure problems behind the eardrum.
        </ImageCard>
        <InfoCard title="Speech Audiometry">
          Assesses how clearly you understand speech at different volumes — a key measure for planning the right hearing aid fitting.
        </InfoCard>
      </div>
      ...
      <div className="grid gap-5 md:grid-cols-3">
        <ImageCard title="Newborn Hearing Screening" img="/assets/newborn-hearing-screening.webp" alt="Newborn baby undergoing a gentle hearing screening">
          Quick, painless screening to identify hearing concerns from the earliest days of life.
        </ImageCard>
        <ImageCard title="Play Audiometry" img="/assets/play-audiometry.webp" alt="Young child taking a play-based hearing test with an audiologist">
          Turns the hearing test into a game so young children can respond reliably and comfortably.
        </ImageCard>
        <ImageCard title="ABR / BAER & ASSR" img="/assets/abr-baer-assr.webp" alt="Infant undergoing an ABR/BAER and ASSR objective hearing test with electrodes">
          Objective tests that measure how the hearing nerve and brainstem respond to sound and estimate hearing thresholds — ideal for infants and children who can&rsquo;t respond to standard tests.
        </ImageCard>
      </div>
