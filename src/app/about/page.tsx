  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Linaw Dinig is a trusted provider of hearing healthcare solutions, committed to improving the quality of life for individuals experiencing hearing loss — with compassion and a patient-centered approach."
      />
