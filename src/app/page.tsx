...
export const metadata: Metadata = {
  title: "Linaw Dinig Hearing Aid Center — Free Hearing Tests & Hearing Aids in Tanay, Rizal",
  description: "Trusted hearing care offering comprehensive hearing evaluation for adults & children, hearing aid fitting & customization, repair & maintenance, follow-up care and assistive listening devices. Book your free consultation today.",
  openGraph: {
    title: "Linaw Dinig Hearing Aid Center — Clear Hearing. Better Living.",
    description: "Independent audiology clinic in Tanay, Rizal. Free hearing tests, expert fittings and ongoing care.",
    images: ["/og-home.jpg"],
  },
};
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 md:grid-cols-2 md:gap-12 md:px-6 md:py-20 lg:py-24">
        <div>
          ...
          <p className="mt-5 max-w-xl text-lg text-muted-foreground md:text-xl">
            Expert hearing tests, hearing aid fittings and ongoing care — at our main office in Tanay, Rizal, with branches in Cebu, Dasmariñas and La Union.
          ...
          <p className="mt-5 text-sm font-semibold text-muted-foreground">
            Trusted by 5,000+ patients · Qualified Audiologists · All Major Brands
          </p>
        </div>
        <div className="relative">
          ...
          <div className="absolute -bottom-5 -left-5 hidden rounded-2xl border border-border bg-card p-4 shadow-soft md:block">
            ...
            <p className="text-xs text-muted-foreground">based on 280+ reviews</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="bg-background py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <ServiceCard icon={<Headphones className="size-6" />} title="Hearing Aid Fitting & Customization" desc="Matched to your lifestyle, hearing loss and budget." to="/services/hearing-aid-fittings" />
          <ServiceCard icon={<Wrench className="size-6" />} title="Hearing Aid Repair & Maintenance" desc="Fast, reliable service for various brands." to="/services/hearing-aid-repairs" />
